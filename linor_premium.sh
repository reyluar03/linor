...
dbhost='185.62.188.4';
dbuser='linorvpp_Panel';
dbpass='Linor123';
dbname='linorvpp_Panel';
dbport='3306';
clear
dt=$(date '+%d/%m/%Y %H:%M:%S');
echo "$dt"
...
${reset}"
echo "${cyan}
Re-Edited by: -Rey for Linor VPN-
For CENTOS 6.9 x64
...
$DB_user = "linorvpp_Panel";
$DB_pass = "Linor123";
$DB_name = "linorvpp_Panel";
$DB_port = "3306";
...
sh premium-active.sh
sh premium-not-active.sh
history -c
clear
...
Premium Autoscript of Linor VPN ${reset}"
