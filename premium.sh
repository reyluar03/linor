...
clear
#get active.txt 
wget https://raw.githubusercontent.com/reyluar03/linor/master/ssh/premiumactive.sh
wget https://raw.githubusercontent.com/reyluar03/linor/master/ssh/premiumnotactive.sh
