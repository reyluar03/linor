...
sleep 4s
#get active.txt 
wget https://raw.githubusercontent.com/reyluar03/linor/master/ssh/vipactive.sh
wget https://raw.githubusercontent.com/reyluar03/linor/master/ssh/vipnotactive.sh
