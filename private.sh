...
clear
#get active.txt 
wget https://raw.githubusercontent.com/reyluar03/linor/master/ssh/privateactive.sh
wget https://raw.githubusercontent.com/reyluar03/linor/master/ssh/privatenotactive.sh
